    ...
    if (!res.ok) {
        ...
        return (
            <div className="min-h-screen bg-[#F8F7FF] dark:bg-zinc-950 text-gray-900 dark:text-zinc-100 p-8 flex items-center justify-center">
                <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-red-100 dark:border-red-900/50 shadow-sm text-center max-w-md">
        ...
        <div className="min-h-screen bg-[#F8F7FF] dark:bg-zinc-950 text-gray-900 dark:text-zinc-100 p-8">
            <div className="max-w-7xl mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-sm text-gray-500 dark:text-zinc-400 mt-1">{total} record{total === 1 ? '' : 's'} compiled</p>
                </div>

                <ResumeFilters totalPages={totalPages} currentPage={currentPage} />

                {resumes.length === 0 ? (
                    <div className="text-center py-16 bg-white dark:bg-zinc-900 border border-gray-150 dark:border-zinc-800 rounded-2xl">
                        <p className="text-gray-400 dark:text-zinc-500">No resumes found matching your filter criteria.</p>
                    </div>
                ) : (

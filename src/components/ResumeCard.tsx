...
export default function ResumeCard({ resume }: ResumeCardProps) {
    return (
        <div className="bg-white border border-gray-100 rounded-2xl p-5 w-full shadow-sm hover:shadow-md hover:border-indigo-150 transition-all flex flex-col justify-between h-full">
            <div>
            ...
            <Link
                ...
                className="mt-6 w-full text-center inline-block rounded-xl bg-indigo-650 px-4 py-2.5 text-xs font-bold text-white hover:bg-indigo-700 transition shadow-sm hover:shadow shadow-indigo-200"
            >
                View Details
            </Link>
        </div>
